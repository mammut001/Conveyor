...
the contact method listed in [`SECURITY.md`](SECURITY.md). All
...
The original body was adapted from the
[Contributor Covenant][covenant] revision 2.1, with minor wording edits
to fit a single-maintainer open-source project.
