...
PY ?= .venv/bin/python
SMOKE_FREE = scripts/auto_maintain_smoke.py scripts/compress_day_smoke.py scripts/clean_worktrees_smoke.py scripts/clean_old_jobs_smoke.py scripts/classify_memo_smoke.py
